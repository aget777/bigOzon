...
def getProductInfoPrices():
    ...
    while i < 1:
        ...
        productInfoPricesModels += _mapModels(jsonResults)

        print(len(jsonResults))
        i += 1
    return productInfoPricesModels
...
def _mapModels(jsonResults):
    ...
    for jsonResult in jsonResults:
        productInfoPricesModel = ResponseModels.ProductInfoPricesModels(jsonResult)
        productInfoPricesModels.append(productInfoPricesModel)
